...
[**updateExercise**](SpecsExercisesAPI.md#updateexercise) | **PUT** /v1/specs/exercises/{id} | 更新動作（整筆取代 name / muscle_group / description）
...
let exerciseInput = ExerciseInput(id: 123, name: "name_example", muscleGroup: MuscleGroup(), description: "description_example") // ExerciseInput | 
