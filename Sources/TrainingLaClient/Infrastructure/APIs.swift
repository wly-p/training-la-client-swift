...
open class TrainingLaClientAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = TrainingLaClientAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: TrainingLaClientAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: TrainingLaClientAPIConfiguration = TrainingLaClientAPIConfiguration.shared
    ) {
        self.method = method
